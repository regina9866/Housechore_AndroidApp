...
public class ContactDetailsFragment extends Fragment implements View.OnClickListener {
    ...
    public static ContactDetailsFragment newInstance(String mode, int sectionNumber, long choreId) {
...
//        TabLayoutActivity myActivity = (TabLayoutActivity) getActivity();
        ...
        mNote.setText(mChore.getmNote());
//        mPoint.setText(mChore.getmPoint());
        Log.d("텍스트뷰성공"," ");
...
//
        ...
        mNote = (TextView)mRootView.findViewById(R.id.note);
//        mPoint = (TextView)mRootView.findViewById(R.id.point);
